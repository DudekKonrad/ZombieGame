...
class Wander(Face):
    ...
    def get_steering(self):
        ...
        target = np.add(self.get_character().position,
                        np.multiply(self.wander_offset, orientation_scalar_to_vector(self.get_character().orientation)))
        ...
        steering.linear = np.multiply(self.max_acceleration,
                                      orientation_scalar_to_vector(self.get_character().orientation))
        return steering
