...
class Wander(Face):
    ...
    def get_steering(self):
        ...
        # print("wandr orientation = ", self.wander_orientation)
...
class Zombie:
    ...
    def update(self):
        ...
        # print(self.wander.character.position[0])
        # print(self.wander.character.position[1])
        # print("")
...
#         # self.wander.character.position = position
    
#     def draw(self):
#         # print("draw start position", self.wander.character.position)
#         pygame.draw.circle(window, self.color, self.wander.character.position, self.radius)
#         # print("draw end position", self.wander.character.position)
...
#     # steering behaviors: wander
#     def update(self):
#         self.wander.character.update(self.wander.get_steering(), 10.0, self.time)
#         # print(self.wander.character.position[0])
#         # print(self.wander.character.position[1])
#         # print("")
